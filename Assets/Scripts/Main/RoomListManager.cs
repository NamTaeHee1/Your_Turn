...
public class RoomListManager : MonoBehaviourPunCallbacks
{
    ...
    void MyListRenewal()
    {
        ...
        for(int i = 0; i < CellButton.Length; i++)
        {
            ...
            CellButton[i].transform.GetChild(1).GetComponent<TextMeshProUGUI>().text = (Multiple + i < MyList.Count) ? string.Format("팀당 {0}명", (MyList[Multiple + i].MaxPlayers).ToString()) : "";
        }
    }
